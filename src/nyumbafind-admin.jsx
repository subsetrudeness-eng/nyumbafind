...
const ADMIN_PASSWORD = process.env.REACT_APP_ADMIN_PASSWORD || "admin123"; // Set in Vercel env vars!
...
export default function AdminApp() {
  ...
  return (
    <div className="admin-layout" style={{ minHeight:"100vh",background:"#f8fdf9",fontFamily:"'DM Sans',sans-serif",display:"flex" }}>
      ...
      {/* SIDEBAR */}
    <div className="admin-sidebar{{ width:200,background:"#052e16",minHeight:"100vh",padding:"20px 12px",display:"flex",flexDirection:"column",flexShrink:0,position:"sticky",top:0,height:"100vh",overflowY:"auto" }}>
